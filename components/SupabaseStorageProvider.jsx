...
import { uploadFile } from './SupabaseStorage/Methods/uploadFile';
    ...
    () => {
      return {
        ...
        uploadFile: async (path, base64FileData, contentType, upsert) => {
          ...
          setError(null)
          try {
            const arrayBufferFileData = decode(base64FileData);
            const result = await uploadFile(bucketName, path, arrayBufferFileData, contentType, upsert);
